; ModuleID = 'src/test_file2.cpp'
source_filename = "src/test_file2.cpp"
...
%class.test_file2 = type { i8 }

@_ZStL8__ioinit = internal global %"class.std::ios_base::Init" zeroinitializer, align 1
@__dso_handle = external hidden global i8
@_ZSt4cout = external dso_local global %"class.std::basic_ostream", align 8
@.str = private unnamed_addr constant [20 x i8] c"\0A\0ATEST FUNCTION 2\0A\0A\00", align 1
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_test_file2.cpp, i8* null }]

@_ZN10test_file2C1Ev = dso_local unnamed_addr alias void (%class.test_file2*), void (%class.test_file2*)* @_ZN10test_file2C2Ev
...
define dso_local void @_ZN10test_file2C2Ev(%class.test_file2* %this) unnamed_addr #4 align 2 {
entry:
  %this.addr = alloca %class.test_file2*, align 8
  store %class.test_file2* %this, %class.test_file2** %this.addr, align 8
  %this1 = load %class.test_file2*, %class.test_file2** %this.addr, align 8
  ret void
}

; Function Attrs: noinline optnone uwtable
define dso_local void @_ZN10test_file213test_functionEv() #5 align 2 {
entry:
