; ModuleID = 'src/test_file3.cpp'
source_filename = "src/test_file3.cpp"
...
@.str = private unnamed_addr constant [20 x i8] c"\0A\0ATEST FUNCTION 3\0A\0A\00", align 1
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_test_file3.cpp, i8* null }]

@_ZN10test_file3C1Ev = dso_local unnamed_addr alias void (%class.test_file3*), void (%class.test_file3*)* @_ZN10test_file3C2Ev
...
define dso_local void @_ZN10test_file3C2Ev(%class.test_file3* %this) unnamed_addr #4 align 2 {
entry:
  %this.addr = alloca %class.test_file3*, align 8
  store %class.test_file3* %this, %class.test_file3** %this.addr, align 8
  %this1 = load %class.test_file3*, %class.test_file3** %this.addr, align 8
  ret void
}

; Function Attrs: noinline optnone uwtable
define dso_local void @_ZN10test_file313test_functionEv(%class.test_file3* %this) #5 align 2 {
entry:
  %this.addr = alloca %class.test_file3*, align 8
  store %class.test_file3* %this, %class.test_file3** %this.addr, align 8
  %this1 = load %class.test_file3*, %class.test_file3** %this.addr, align 8
