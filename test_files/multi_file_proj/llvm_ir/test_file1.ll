; ModuleID = 'src/test_file1.cpp'
source_filename = "src/test_file1.cpp"
...
%class.test_file1 = type { i8 }
%class.test_file3 = type { i8 }

@_ZStL8__ioinit = internal global %"class.std::ios_base::Init" zeroinitializer, align 1
@__dso_handle = external hidden global i8
@_ZSt4cout = external dso_local global %"class.std::basic_ostream", align 8
@.str = private unnamed_addr constant [20 x i8] c"\0A\0ATEST FUNCTION 1\0A\0A\00", align 1
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_test_file1.cpp, i8* null }]

@_ZN10test_file1C1Ev = dso_local unnamed_addr alias void (%class.test_file1*), void (%class.test_file1*)* @_ZN10test_file1C2Ev
...
define dso_local void @_ZN10test_file1C2Ev(%class.test_file1* %this) unnamed_addr #4 align 2 {
entry:
  %this.addr = alloca %class.test_file1*, align 8
  %testObj3 = alloca %class.test_file3, align 1
  store %class.test_file1* %this, %class.test_file1** %this.addr, align 8
  %this1 = load %class.test_file1*, %class.test_file1** %this.addr, align 8
  call void @_ZN10test_file3C1Ev(%class.test_file3* %testObj3)
  call void @_ZN10test_file313test_functionEv(%class.test_file3* %testObj3)
  ret void
}

declare dso_local void @_ZN10test_file3C1Ev(%class.test_file3*) unnamed_addr #1

declare dso_local void @_ZN10test_file313test_functionEv(%class.test_file3*) #1

; Function Attrs: noinline optnone uwtable
define dso_local void @_ZN10test_file113test_functionEv(%class.test_file1* %this) #4 align 2 {
entry:
  %this.addr = alloca %class.test_file1*, align 8
  store %class.test_file1* %this, %class.test_file1** %this.addr, align 8
  %this1 = load %class.test_file1*, %class.test_file1** %this.addr, align 8
