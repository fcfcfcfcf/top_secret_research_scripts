...
entry:
  ...
  %testObj1 = alloca %class.test_file1*, align 8
  %exn.slot = alloca i8*
  %ehselector.slot = alloca i32
  store i32 0, i32* %retval, align 4
  %call = call i8* @_Znwm(i64 1) #7
  %0 = bitcast i8* %call to %class.test_file1*
  invoke void @_ZN10test_file1C1Ev(%class.test_file1* %0)
          to label %invoke.cont unwind label %lpad

invoke.cont:                                      ; preds = %entry
  store %class.test_file1* %0, %class.test_file1** %testObj1, align 8
  %1 = load %class.test_file1*, %class.test_file1** %testObj1, align 8
  call void @_ZN10test_file113test_functionEv(%class.test_file1* %1)
...
declare dso_local void @_ZN10test_file1C1Ev(%class.test_file1*) unnamed_addr #1
...
declare dso_local void @_ZN10test_file113test_functionEv(%class.test_file1*) #1

declare dso_local void @_ZN10test_file213test_functionEv() #1
